import { ChannelType, Collection, CommandInteraction, InteractionType, PermissionFlagsBits, } from 'discord.js';
            ...
            if (command.player) {
                ...
                if (command.player.dj) {
                    ...
                    if (dj && dj.mode) {
                        ...
                        const findDJRole = interaction.member.roles.cache.find((x) => djRole.map((y) => y.roleId).includes(x.id));
                        if (!findDJRole) {
