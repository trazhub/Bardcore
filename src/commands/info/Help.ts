    ...
    public async run(client: Lavamusic, ctx: Context, args: string[]): Promise<any> {
        ...
        if (!args[0]) {
            ...
            const helpEmbed = embed
                ...
                .setTitle('Help Menu')
                .setDescription(
                    `Hey there! I'm ${this.client.user.username}, a music bot made with [Bardcore](https://github.com/ and Discord. You can use \`${prefix}help <command>\` to get more info on a command.`
                )
                .setFooter({
